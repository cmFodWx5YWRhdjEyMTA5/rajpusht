...
import in.co.rajpusht.rajpusht.fragment.FragmentCashThird;
...
public class CashThirdActivity extends AppCompatActivity
                            implements  FragmentCashThird.OnCallbackReceivedThird{
    public static final String TAG = CashThirdActivity.class.getSimpleName();
    ...
    //Fragments
    FragmentCashThird fragmentCashThird;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if(buttonNext.getText().toString().equalsIgnoreCase("SAVE")||buttonNext.getText().toString().equalsIgnoreCase("UPDATE"))
                {
                    ...
                    if(ANCDate.equalsIgnoreCase(""))
                    {
                        ...
                        position=0;
                        layoutPreview.setVisibility(View.GONE);
                        Toast.makeText(CashThirdActivity.this, "ANC Date can't be empty!", Toast.LENGTH_SHORT).show();
                    }else
                    {
                        methodSubmit();
                    }
        ...
        if(this.getIntent().getExtras() != null && this.getIntent().getExtras().containsKey("edit_form_3"))
        {
            ...
            editor.putString("in_edit_form_3","in_edit_form_3");
            editor.apply();
        ...
        } else
        {
            ...
            SharedPreferences preferencesJSON = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
            SharedPreferences.Editor editor = preferencesJSON.edit();
            editor.putString("in_edit_form_3","not_in_edit_form_3");
            editor.apply();
    ...
    private void methodSubmit() {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  Toast.makeText(CashThirdActivity.this, "Submitted", Toast.LENGTH_SHORT).show();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        fragmentCashThird = new FragmentCashThird();
        fragmentPreview = new FragmentPreview();
        adapter.addFragment(fragmentCashThird, "");
        adapter.addFragment(fragmentPreview, "");
        viewPager.setAdapter(adapter);
    }

    @Override
    public void updateThird(String mData) {
        stringPreview = mData;
        Log.d(TAG, mData);
    }
    ...
    private void pushUpdatedDatatoServer()
    {
        ...
        form3Model.setLast_anc_date(pArray[0].trim());
        //total weeks
        form3Model.setWeight(pArray[2].trim());
        form3Model.setNon_compliance_reason(pArray[3].trim());
...
//        String reason_for_non_compliance = pArray[3];
        ...
        try {
            ...
            String LNCDate = form3Model.getLast_anc_date();
            ...
            jsonSection3.put("reason", form3Model.getNon_compliance_reason());

            jsonForm3.put("section1", jsonSection1);
            jsonForm3.put("section2", jsonSection2);
            jsonForm3.put("section3", jsonSection3);
        ...
        Log.e("jsonForm", jsonForm3.toString());

        pushDataJson = jsonForm3.toString();
    ...
    public class PushCashUpdateAsync extends AsyncTask<String, String, String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CashThirdActivity.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            try
            {
                ...
                if(isEditable == false)
                {
                    httpPost = new HttpPost(CASH_BASE_URL + "beneficiary/updateBeneficiary?formNo=3");

                }else if(isEditable == true)
                {
                    httpPost = new HttpPost(CASH_BASE_URL + "beneficiary/editBeneficiary?formNo=3");
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(CashThirdActivity.this, "Failed to Submit", Toast.LENGTH_SHORT).show();
            }
